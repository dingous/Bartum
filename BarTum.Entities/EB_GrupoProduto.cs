...
namespace BarTum.Entities
{
    ...
    [MetadataType(typeof(EB_GrupoProdutoMetadata))]
    public partial class EB_GrupoProduto
    {
        ...
        public bool Valida(EB_GrupoProduto model)
        {
            ...
            try
            {
                ...
                TypeDescriptor.AddProviderTransparent(
                    new AssociatedMetadataTypeTypeDescriptionProvider(typeof(EB_GrupoProduto), typeof(EB_GrupoProdutoMetadata)),
                    typeof(EB_GrupoProduto)
                 );
    ...
    public class EB_GrupoProdutoMetadata
    {
