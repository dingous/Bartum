...
{
    public partial class frmContasPagarList : Form
    {
        ...
        public void somaTotalPago()
        {
            var query = (from eb_contas in
                             (from eb_contas in _context.EB_Contas
                              where
                                eb_contas.flBaixada == true && eb_contas.TipoLanctoID == 2
                              select new
                              {
        ...
        public void somaTotalAPagar()
        {
            var query = (from eb_contas in
                             (from eb_contas in _context.EB_Contas
                              where
                                eb_contas.flBaixada == false && eb_contas.TipoLanctoID == 2
                              select new
                              {
                                  eb_contas.vlConta,
                                  Dummy = "x"
        ...
        public void populaGridview()
        {
            ...
            query = (from item in _context.EB_Contas.AsEnumerable()
                     where item.TipoLanctoID == 2
                     ...
                     select new GridClass
                     {
                         ...
                         dsPlanoContas = item.EB_PlanoContas.dsPlanoConta,
                         situacao = item.flBaixada == true ? "PAGO" : "A PAGAR",
                         dsNomeFornecedor = item.EB_Fornecedor != null ? item.EB_Fornecedor.dsNomeFantasia : " - ",
            ...
            try
            {
                ...
                switch(tipoBusca)
                {
                    ...
                    .Where(a =>
                               ...
                               a.dsNomeFornecedor.Contains(criterio)
                            );
                    break;
            ...
            try
            {
                ...
                DataGridViewCell colunaSituacao;
                 ...
                 for (int i = 0; i < eB_ContasDataGridView.Rows.Count; i++)
                 {
                     ...
                     if (dataAtual > dtVencimento && colunaSituacao.Value.Equals("A PAGAR"))
                     {
