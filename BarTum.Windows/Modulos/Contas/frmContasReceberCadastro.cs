...
{
    public partial class frmContasReceberCadastro : Form
    {
        BarTumEntities _context = new BarTumEntities();


        public frmContasReceberList frmContasReceberList;
        public decimal id;
        ...
        public frmContasReceberCadastro()
        {
            InitializeComponent();
        ...
        public void populaPlanoContas()
        {
            ...
            var query = (from plano in _context.EB_PlanoContas where plano.TipoLanctoID == 1  select new { plano.dsPlanoConta, plano.PlanoContaID });
        ...
        public void populaClientes(decimal? idCliente)
        {

            BarTumEntities context = new BarTumEntities();
            var query = (from a in context.EB_Cliente where a.flExcluido == false && a.ClienteID == idCliente orderby a.dsNome ascending select new { a.dsNome, a.ClienteID });
        ...
        public void preencheFormularioEdit()
        {
            ...
            try
            {
                ...
                var ContasEnt = this.frmContasReceberList._context.EB_Contas.Single(cl => cl.contasID == this.id);
                ...
                populaClientes(ContasEnt.clienteID);
                txtClienteID.SelectedValue = ContasEnt.clienteID;
        ...
        private void fill(ref EB_Contas ContasEnt)
        {
            ...
            ContasEnt.pai = 0;
            ContasEnt.clienteID = Convert.ToDecimal(txtClienteID.SelectedValue);
            ContasEnt.PlanoContaID = Convert.ToDecimal(combo.SelectedValue);
            ContasEnt.TipoLanctoID = 1; //receita
        ...
        public bool validaCaixa(DateTime data)
        {
            ...
            else if (query.Count > 0)
            {
                ...
                if (query[0].item.EB_CaixaHistoricoFechamento.SingleOrDefault().dsStatus == "fechado")
                {
                    MessageBoxButtons buttons = MessageBoxButtons.YesNo;
                    DialogResult result;
                    result = MessageBox.Show(this, "O caixa nesta data já foi fechado deseja creditar o valor assim mesmo?", "BarTum", buttons,
                    MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
        ...
        private void botaoSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtContasID.Text == "")
                {
                    ...
                    frmMain frmMain = (frmMain)this.frmMain;
                  ...
                  if (ContasEnt.Valida(ContasEnt))
                    {
                        ...
                        this.frmContasReceberList._context.AddToEB_Contas(ContasEnt);
                        this.frmContasReceberList._context.SaveChanges();
                        ...
                        if (this.frmContasReceberList != null)
                        {
                            this.frmContasReceberList.ComboExibir_SelectedIndexChanged(null, null);
                        }
                ...
                else
                {
                    ...
                    ContasEnt = this.frmContasReceberList._context.EB_Contas.Single(cl => cl.contasID == id);
        ...
        private void botaoBuscarPendentes_Click(object sender, EventArgs e)
        {
            ...
            frm.frmContasReceberCadastro = this;
            frm.frmMain = (frmMain)this.frmMain;
            frm.ShowDialog();
